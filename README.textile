...
You should see the application download. Once that's complete, simply navigate into the directory containing manage.py and type @python manage.py runserver@ and the app should start as normal. Remmeber that you can view it in your browser at the address *127.0.0.1:8000*.